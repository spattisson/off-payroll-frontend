...
object FinancialRiskCluster extends Cluster {
  ...
  val clusterElements: List[Element] = List(
    Element("haveToPayButCannotClaim", GROUP, 0, this,
      List(
        Element("haveToPayButCannotClaim.workerProvidedMaterials", CHECKBOX, 0, this),
        Element("haveToPayButCannotClaim.workerProvidedEquipment", CHECKBOX, 1, this),
        Element("haveToPayButCannotClaim.workerUsedVehicle", CHECKBOX, 2, this),
        Element("haveToPayButCannotClaim.workerHadOtherExpenses", CHECKBOX, 3, this),
        Element("haveToPayButCannotClaim.expensesAreNotRelevantForRole", CHECKBOX, 4, this)
      )),
