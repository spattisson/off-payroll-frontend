...
object FinancialRiskBCluster extends Cluster {
  ...
  val clusterElements: List[Element] = List(
    ...
    Element("workerMainIncome", RADIO, 4, this),
  ...
  private val flows = List(
    ...
    FlowElement("financialRiskB.workerMainIncome",
      Map("financialRiskB.workerMainIncome" -> "incomeCalendarPeriods"),
      Option("financialRiskB.workerProvideAtTheirExpense")),
    FlowElement("financialRiskB.workerMainIncome",
      Map("financialRiskB.workerMainIncome" -> "incomePieceRate"),
      Option("financialRiskB.workerProvideAtTheirExpense")),
    FlowElement("financialRiskB.workerMainIncome",
      Map("financialRiskB.workerMainIncome" -> "incomeCommission"),
      Option("financialRiskB.workerProvideAtTheirExpense")),
    FlowElement("financialRiskB.workerMainIncome",
      Map("financialRiskB.workerMainIncome" -> "incomeFixed"),
      Option("financialRiskB.workerProvideAtTheirExpense")),
    FlowElement("financialRiskB.workerMainIncome",
      Map("financialRiskB.workerMainIncome" -> "incomeProfitOrLosses"),
      Option("financialRiskB.workerProvideAtTheirExpense")),
